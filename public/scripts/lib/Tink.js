  ...
  addGlobalPositionProperties(sprite) {
    if (sprite.gx === undefined) {
      Object.defineProperty(
        ...
        "gx", {
          get() {
            return sprite.toGlobal(new PIXI.Point(0,0)).x;
          }
        }
      );
    }
    ...
    if (sprite.gy === undefined) {
      Object.defineProperty(
        ...
        "gy", {
          get() {
            return sprite.toGlobal(new PIXI.Point(0,0)).y;
          }
        }
      );
    }
...
// Module exporting for RequireJS
define(function() {
  return function(PIXI, element, scale = 1) {
      return new Tink(PIXI, element, scale);
  }
});